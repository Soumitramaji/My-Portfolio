...
const Navbar = () => {
    ...
    return (
        <nav ref={navRef} className={`fixed top-0 w-full z-50 transition-all duration-700 ease-in-out px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled
            ? "bg-[#050414]/30 backdrop-blur-md shadow-md"
            : "bg-transparent"}`}>
            <div className='text-white py-5 flex justify-between items-center'>
                {/* Name Logo */}
                <div className='text-lg font-semibold cursor-pointer'>
                    <span className='text-[#8245ec]'>&lt;</span>
                    <span className='text-white'>Soumitra</span>
                    <span className='text-[#8245ec]'>/</span>
                    <span className='text-white'>Maji</span>
                    <span className='text-[#8245ec]'>&gt;</span>
                </div>
                ...
                <div className='hidden md:flex space-x-4'>
                    <a
                        href="https://github.com/Soumitramaji"
                        target='_blank'
                    ...
                    <a
                        href="https://www.linkedin.com/in/soumitra-maji"
                        target='_blank'
                        rel='noopener noreferrer'
                        className='text-gray-300 hover:text-[#8245ec]'
                    >
